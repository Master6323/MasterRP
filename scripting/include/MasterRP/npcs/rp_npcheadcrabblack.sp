...
initNpcHeadCrabBlack()
{
	...
	//NPC Beta:
	RegAdminCmd("sm_testheadcrabblack", Command_CreateNpcHeadCrabBlack, ADMFLAG_ROOT, "<id> <NPC> <type> - Types: 0 = Job Lister, 1 = Banker, 2 = Vendor");
...
//Event Damage:
public Action:OnHeadCrabBlackDamageClient(Client, &attacker, &inflictor, &Float:damage, &damageType)
{
...
//Event Damage:
public Action:OnClientDamageHeadCrabBlack(Ent, &Client, &inflictor, &Float:damage, &damageType)
{
...
//Ant Lion Died Event:
public OnHeadCrabBlackDied(const String:Output[], Caller, Activator, Float:Delay)
{
...
//Create NPC:
public Action:Command_CreateNpcHeadCrabBlack(Client, Args)
{
...
public CreateNpcHeadCrabBlack(String:Model[], Float:Position[3], Float:Angles[3], Health)
{
	...
	//Initialize:
	new NPC = CreateEntityByName("npc_headcrab_black");
