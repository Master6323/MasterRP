...
initNpcHeadCrabFast()
{
	...
	//NPC Beta:
	RegAdminCmd("sm_testheadcrabfast", Command_CreateNpcHeadCrabFast, ADMFLAG_ROOT, "<id> <NPC> <type> - Types: 0 = Job Lister, 1 = Banker, 2 = Vendor");
...
//Event Damage:
public Action:OnHeadCrabFastDamageClient(Client, &attacker, &inflictor, &Float:damage, &damageType)
{
...
//Event Damage:
public Action:OnClientDamageHeadCrabFast(Ent, &Client, &inflictor, &Float:damage, &damageType)
{
...
//Ant Lion Died Event:
public OnHeadCrabFastDied(const String:Output[], Caller, Activator, Float:Delay)
{
...
//Create NPC:
public Action:Command_CreateNpcHeadCrabFast(Client, Args)
{
...
public CreateNpcHeadCrabFast(String:Model[], Float:Position[3], Float:Angles[3], Health)
{
	...
	//Initialize:
	new NPC = CreateEntityByName("npc_headcrabfast");
