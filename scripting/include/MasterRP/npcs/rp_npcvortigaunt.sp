...
public Action:PluginInfo_NpcVortigaunt(Client)
{
...
initNpcVortigaunt()
{
	...
	//NPC Beta:
	RegAdminCmd("sm_testvortigaunt", Command_CreateNpcVortigaunt, ADMFLAG_ROOT, "<id> <NPC> <type> - Types: 0 = Job Lister, 1 = Banker, 2 = Vendor");
...
//Event Damage:
public Action:OnVortigauntDamageClient(Client, &attacker, &inflictor, &Float:damage, &damageType)
{
...
//Event Damage:
public Action:OnClientDamageVortigaunt(Ent, &Client, &inflictor, &Float:damage, &damageType)
{
...
//Ant Lion Died Event:
public OnVortigauntDied(const String:Output[], Caller, Activator, Float:Delay)
{
...
//Create NPC:
public Action:Command_CreateNpcVortigaunt(Client, Args)
{
...
public CreateNpcVortigaunt(String:Model[], Float:Position[3], Float:Angles[3], Health)
{
	...
	//Initialize:
	new NPC = CreateEntityByName("npc_vortigaunt");
