...
public Action:PluginInfo_NpcStrider(Client)
{
...
initNpcStrider()
{
	...
	//NPC Beta:
	RegAdminCmd("sm_teststrider", Command_CreateNpcStrider, ADMFLAG_ROOT, "<id> <NPC> <type> - Types: 0 = Job Lister, 1 = Banker, 2 = Vendor");
...
//Event Damage:
public Action:OnStriderDamageClient(Client, &attacker, &inflictor, &Float:damage, &damageType)
{
...
//Event Damage:
public Action:OnClientDamageStrider(Ent, &Client, &inflictor, &Float:damage, &damageType)
{
...
//Ant Lion Died Event:
public OnStriderDied(const String:Output[], Caller, Activator, Float:Delay)
{
...
//Create NPC:
public Action:Command_CreateNpcStrider(Client, Args)
{
...
public CreateNpcStrider(String:Model[], Float:Position[3], Float:Angles[3], Health)
{
	...
	//Initialize:
	new NPC = CreateEntityByName("npc_strider");
